...
import Classifier.jiant.scripts.download_data.dl_datasets.hf_datasets_tasks as hf_datasets_tasks_download
import Classifier.jiant.scripts.download_data.dl_datasets.xtreme as xtreme_download
import Classifier.jiant.scripts.download_data.dl_datasets.files_tasks as files_tasks_download
from Classifier.jiant.tasks.constants import (
    GLUE_TASKS,
    SUPERGLUE_TASKS,
    XTREME_TASKS,
    BENCHMARKS,
)
from Classifier.jiant.scripts.download_data.constants import (
    SQUAD_TASKS,
