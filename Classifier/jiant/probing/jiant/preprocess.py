...
from Classifier.jiant.huggingface_transformers_interface import (
...
from Classifier.jiant.tasks import (
    ALL_DIAGNOSTICS,
    ALL_COLA_NPI_TASKS,
    ALL_GLUE_TASKS,
    ALL_SUPERGLUE_TASKS,
...
from Classifier.jiant.tasks import REGISTRY as TASKS_REGISTRY
from Classifier.jiant.tasks.seq2seq import Seq2SeqTask
from Classifier.jiant.tasks.tasks import SequenceGenerationTask, Task
from Classifier.jiant.tasks.lm import MaskedLanguageModelingTask
from Classifier.jiant.utils import config, serialize, utils, options
from Classifier.jiant.utils.options import parse_task_list_arg
...
class ModelPreprocessingInterface(object):
    ...
    def __init__(self, args):
        ...
        from Classifier.jiant.models import input_module_uses_pair_embedding, input_module_uses_mirrored_pair
