...
from Classifier.jiant.allennlp_mods.correlation import Correlation
from Classifier.jiant.allennlp_mods.numeric_field import NumericField
from Classifier.jiant.utils import utils
from Classifier.jiant.utils.data_loaders import (
    get_tag_list,
    load_diagnostic_tsv,
    load_span_data,
    load_tsv,
...
from Classifier.jiant.utils.serialize import RepeatableIterator
from Classifier.jiant.utils.tokenizers import get_tokenizer
from Classifier.jiant.utils.retokenize import get_aligner_fn
from Classifier.jiant.tasks.registry import register_task  # global task registry
from Classifier.jiant.metrics.winogender_metrics import GenderParity
from Classifier.jiant.metrics.nli_metrics import NLITwoClassAccuracy
...
class SentenceOrderTask(PairClassificationTask):
    """ Task class for Sentence Order Prediction (SOP). See the ALBERT paper for details on SOP:
        ...
        the data by following the instructions from Classifier.jiant/scripts/sop.
