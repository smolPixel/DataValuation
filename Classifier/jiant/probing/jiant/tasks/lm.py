...
from Classifier.jiant.utils.data_loaders import tokenize_and_truncate, get_tokenizer
from Classifier.jiant.tasks.registry import register_task
from Classifier.jiant.tasks.tasks import Task
...
class MaskedLanguageModelingTask(Task):
    ...
    instructions from Classifier.jiant/scripts/mlm. 
    """
