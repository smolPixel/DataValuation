...
from Classifier.jiant import evaluate
from Classifier.jiant.models import build_model
from Classifier.jiant.preprocess import build_tasks
from Classifier.jiant import tasks as task_modules
from Classifier.jiant.trainer import build_trainer
from Classifier.jiant.utils import config, tokenizers
...
def initial_setup(args: config.Params, cl_args: argparse.Namespace) -> (config.Params, int):
    ...
    if cl_args.remote_log:
        from Classifier.jiant.utils import gcp

        gcp.configure_remote_logging(args.remote_log_name)

    if cl_args.notify:
        from Classifier.jiant.utils import emails
