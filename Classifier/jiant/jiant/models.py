...
from Classifier.jiant.allennlp_mods.elmo_text_field_embedder import (
    ElmoTextFieldEmbedder,
    ElmoTokenEmbedderWrapper,
)

from Classifier.jiant.modules.edge_probing import EdgeClassifierModule
from Classifier.jiant.modules.simple_modules import (
    Pooler,
    Classifier,
    SingleClassifier,
    PairClassifier,
...
from Classifier.jiant.modules.attn_pair_encoder import AttnPairEncoder
from Classifier.jiant.modules.sentence_encoder import SentenceEncoder
from Classifier.jiant.modules.bilm_encoder import BiLMEncoder
from Classifier.jiant.modules.bow_sentence_encoder import BoWSentEncoder
from Classifier.jiant.modules.elmo_character_encoder import ElmoCharacterEncoder
from Classifier.jiant.modules.onlstm_phrase_layer import ONLSTMPhraseLayer
from Classifier.jiant.modules.prpn_phrase_layer import PRPNPhraseLayer
from Classifier.jiant.modules.onlstm.ON_LSTM import ONLSTMStack
from Classifier.jiant.modules.prpn.PRPN import PRPN
from Classifier.jiant.modules.seq2seq_decoder import Seq2SeqDecoder
from Classifier.jiant.modules.span_modules import SpanClassifierModule
from Classifier.jiant.huggingface_transformers_interface import input_module_uses_transformers
from Classifier.jiant.tasks.edge_probing import EdgeProbingTask
from Classifier.jiant.tasks.lm import AutoregressiveLanguageModelingTask, MaskedLanguageModelingTask
from Classifier.jiant.tasks.lm_parsing import LanguageModelingParsingTask
from Classifier.jiant.tasks.qa import MultiRCTask, ReCoRDTask
from Classifier.jiant.tasks.seq2seq import Seq2SeqTask
from Classifier.jiant.tasks.tasks import (
    GLUEDiagnosticTask,
    MultipleChoiceTask,
...
from Classifier.jiant.utils import config
from Classifier.jiant.utils.utils import (
    assert_for_log,
    get_batch_size,
...
from Classifier.jiant.utils.data_loaders import get_tokenizer
...
def build_model(args, vocab, pretrained_embs, tasks, cuda_devices):
    ...
    if args.input_module.startswith("bert-"):
        from Classifier.jiant.huggingface_transformers_interface.modules import BertEmbedderModule
        ...
        from Classifier.jiant.huggingface_transformers_interface.modules import RobertaEmbedderModule
        ...
        from Classifier.jiant.huggingface_transformers_interface.modules import AlbertEmbedderModule

        log.info(f"Using ALBERT model ({args.input_module}).")
        embedder = AlbertEmbedderModule(args)
        d_emb = embedder.get_output_dim()
    elif args.input_module.startswith("xlnet-"):
        from Classifier.jiant.huggingface_transformers_interface.modules import XLNetEmbedderModule
        ...
        from Classifier.jiant.huggingface_transformers_interface.modules import OpenAIGPTEmbedderModule
        ...
        from Classifier.jiant.huggingface_transformers_interface.modules import GPT2EmbedderModule
        ...
        from Classifier.jiant.huggingface_transformers_interface.modules import TransfoXLEmbedderModule
        ...
        from Classifier.jiant.huggingface_transformers_interface.modules import XLMEmbedderModule
...
def build_embeddings(args, vocab, tasks, pretrained_embs=None):
    ...
    if args.cove:
        ...
        try:
            from Classifier.jiant.modules.cove.cove import MTLSTM as cove_lstm
