...
from Classifier.jiant.utils.python.datastructures import ExtendedDataClassMixin, combine_dicts
...
class SuperGlueMixin:
    """Mixin for :class:`Classifier.jiant.tasks.core.Task`s in the `SuperGLUE<https://super.gluebenchmark.com/>`_
    benchmark.
    """
...
class GlueMixin:
    """Mixin for :class:`Classifier.jiant.tasks.core.Task`s in the `GLUE<https://gluebenchmark.com/>`_
    benchmark.
    """
