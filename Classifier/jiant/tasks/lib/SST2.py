...
from Classifier.jiant.tasks.lib.templates.shared import single_sentence_featurize, labels_to_bimap
from Classifier.jiant.utils.python.io import read_jsonl
import pandas as pd
...
class Example(BaseExample):
    ...
    def tokenize(self, tokenizer):
        return TokenizedExample(
            ...
            label_id=SST2task.LABEL_TO_ID[self.label],
        )
