...
from Classifier.jiant.tasks.lib.templates.shared import (
    labels_to_bimap,
    add_cls_token,
    create_input_set_from_tokens_and_segments,
)
from Classifier.jiant.tasks.utils import truncate_sequences
...
class MultiRCTask(SuperGlueMixin, Task):
    ...
    def super_glue_format_preds(pred_dict):
        ...
        """
        lines = []
        # formatting code adapted from: https://github.com/nyu-mll/Classifier.jiant/blob/
        # 14fae87d2ebc5a45dbe7254e9007d1a148dd6b18/Classifier.jiant/evaluate.py#L427
